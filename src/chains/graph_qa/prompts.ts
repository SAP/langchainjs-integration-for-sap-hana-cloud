...
export const SPARQL_GENERATION_SELECT_PROMPT = new PromptTemplate({
  inputVariables: ["schema", "prompt"],
  template: SPARQL_GENERATION_SELECT_TEMPLATE,
});

const SPARQL_QA_TEMPLATE = `
ask: Generate a natural language response from the results of a SPARQL query.
...
Helpful Answer:
`;
export const SPARQL_QA_PROMPT = new PromptTemplate({
